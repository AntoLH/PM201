...
const styles = StyleSheet.create({
  ...
  titulo: { fontSize: 28, fontWeight: 'bold', textAlign: 'center', color: '#1F2937', marginBottom: 20 },
  card: { backgroundColor: '#FFFFFF', borderRadius: 15, padding: 18, marginBottom: 15, elevation: 4, shadowColor: '#000', shadowOpacity: 0.15, shadowRadius: 5, shadowOffset: { width: 0, height: 3 } },
  ...
  botonDetalles: { alignItems: 'flex-end', marginTop: 10 },
  textoDetalles: { color: '#2563EB', fontSize: 14, fontWeight: '500' }
});